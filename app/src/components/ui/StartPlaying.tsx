...
const StartPlaying = () => (
  <section>
    ...
    <p className="mb-6 text-gray-300">
      Choose what you want to play from products below powered by Dexsport.
      Explore and join Web3 sport betting and fast crypto games.
    </p>
    <div className="flex gap-6 flex-wrap justify-center">
      {cards.map((card) => (
        <div
          key={card.title}
          className="bg-[#232136] rounded-xl shadow-lg p-6 flex flex-col items-center w-64 hover:scale-105 transition cursor-pointer"
        >
